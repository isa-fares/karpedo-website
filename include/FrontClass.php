...
class FrontClass extends Mail
{
     ...
     * @return string
     */
    /*Bu fonksiyonu kullanırken $lang parametresini her zaman 'tr' olarak ayarlayın.
    örnek: $this->BaseURL("anasayfa", "tr", 1);
...
EOT;
     ...
     */
    /*
    bu  funckisyunu linkler için kullanıyoruz. örnek: $this->getURL("anasayfa", "anasayfa");
    bu fonksiyonu kullanırken $lang parametresini her zaman 'tr' olarak ayarlayın.
    */
