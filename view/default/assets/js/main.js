(function () {
    ...
    const app = document.getElementById('typewritter');
    ...
    typewriter
        .typeString('Baton Dondurma')
        .pauseFor(500)
        .deleteAll()
        .typeString('Maraş Kesme')
        .pauseFor(500)
        .deleteAll()
        .typeString('Kol Dondurma')
        .pauseFor(500)
        .deleteAll()
        .typeString('Reyon Dondurma')
        .pauseFor(500)
        .deleteAll()
        .typeString('Kase Dondurma')
        .pauseFor(500)
        .deleteAll()
        .start();
