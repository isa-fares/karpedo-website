...
<?php
// Scripts moved to bottom only - duplicate load was breaking multitoggle (project-hamburger gallery panel)
// $this->inc_file("script", array( "js/jquery-3.6.0.min.js", "js/core.min.js", "js/script.js" ));
?>
</head>
