                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-card style-two img-hover-zoom round-20 mb-30">
                            ...
                            <div class="blog-info">
                                <h3 class="fs-24"><a href="blog_detay.html"
                                        class="text-title link-hover-secondary transition">Karpedo’nun Sırrı: Geleneksel
                                        Maraş Usulü Dondurma</a></h3>
                                <a href="blog_detay.html" class="btn style-five position-relative z-1 round-10">Devamını
                                    Oku</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6">
                        <div class="blog-card style-two img-hover-zoom round-20 mb-30">
                            ...
                            <div class="blog-info">
                                <h3 class="fs-24"><a href="blog_detay.html"
                                        class="text-title link-hover-secondary transition">Doğadan Gelen Serinlik:
                                        Gerçek Meyve Taneleriyle Tanışın</a>
                                </h3>
                                <a href="blog_detay.html" class="btn style-five position-relative z-1 round-10">Devamını
                                    Oku</a>
                            </div>
