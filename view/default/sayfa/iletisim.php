                ...
                <div class="container style-one text-center">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xxl-4 col-lg-6 col-md-8 mb-sm-10">
                            <h2 class="br-title fw-normal mb-12">İletişim</h2>
                ...
                <div
                    ...
                    <div class="contact-card style-one d-flex flex-wrap align-items-center mb-30">
                        ...
                        <div class="contact-info">
                            ...
                            <p><a href="#" class="text-para link-hover-primary transition d-block">+90 (344) 236 06
                                    37</a></p>
                        </div>
                    </div>
                    <div class="contact-card style-one d-flex flex-wrap align-items-center mb-30">
                                ...
                                <div class="row gx-xl-3">
                                    ...
                                    <div class="col-12">
                                        <div class="col-xl-5 col-md-6">
                                            <button type="submit"
                                                class="btn style-two position-relative z-1 round-10">Formu
                                                Gönder</button>
                                        </div>
                                    </div>
                                </div>
