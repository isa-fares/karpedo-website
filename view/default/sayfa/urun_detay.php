                ...
                <div class="container style-one text-center">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xxl-4 col-lg-6 col-md-8 mb-sm-10">
                            <h2 class="br-title fw-normal mb-12">Mangolu Dondurma Reyon</h2>
                            <ul class="br-menu list-unstyled mb-0">
                                <li><a href="index.html">Anasayfa</a></li>
                                <li><a href="index.html">Ürünler</a></li>
                                <li>Mangolu Dondurma Reyon</li>
                            </ul>
                        </div>
                        <div class="col-xxl-4 col-lg-3 col-md-2">
                            <div class="br-img">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xxl-7 col-lg-6 ps-xl-5">
                            <div class="single-product-info">
                                <h1 class="fw-normal text-title">Mangolu Dondurma Reyon</h1>
                                <p>Tadını, mevsiminde toplanılan mangodan alan yaz lezzeti Karpedo Mangolu yiyenleri
                                    kendine hayran bırakan dondurma hazzını yaşatıyor. Lezzet yüklü Karpedo Mangolu
                                    Dondurma ile çocuklarınızın veya konuklarınızın yüzünü gülümsetmek isterseniz; iyi
                                    bir öneri. Karpedo Mangolu dondurma ile ikramlarınızda fark oluşturabilirsiniz.
                                    Enfes bir lezzet şöleni sizi bekliyor.</p>
                                <button class="btn style-two position-relative z-1 round-10 mb-25" type="submit">Tedarik
                                    İçin İletişime Geçin</span></button>
                ...
                <div class="tab-content product-tab-content pb-120">
                    <div class="tab-pane fade show active" id="tab_1" role="tabpanel">
                        <div class="product_desc content-detail">
                            <p>–20˚C ve altında muhafaza ediniz. Lütfen çözündükten sonra dondurmayınız.</p>
                            <p>Son kullanma tarihi ve parti numarası paketin üzerindedir. Türk Gıda Kodeksi Dondurma
                                Tebliğine uygun üretilmiştir.</p>
                            <p>Karpedo Dondurma, ISO:9001: 2015 Kalite Yönetim Sistemi ve ISO: 22000: 2018 Gıda
                                Güvenliği Yönetim Sistemi Belgelerine Sahiptir.<br>Bir Porsiyon 60 gr’dır.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div
                            ...
                            <div
                                ...
                                <img src="https://www.karpedo.com/wp-content/uploads/2022/04/21_hurmali_reyon_dondurma00-400x336.png"
                                    alt="Ürün görseli" class="d-block mx-auto">
                            </div>
                            <h3 class="fs-24"><a href="#" class="text-title link-hover-primary">Kesme Dondurma</a></h3>
                            <a href="#" class="btn style-four position-relative z-1 round-10">Ürünü İncele</a>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div
                            ...
                            <div
                                class="product-img d-flex flex-column align-items-center justify-content-center mx-auto">
                                <img src="https://www.karpedo.com/wp-content/uploads/2022/04/08_portakal_reyon_dondurma00-400x336.png"
                                    alt="Ürün görseli" class="d-block mx-auto">
                            </div>
                            <h3 class="fs-24"><a href="#" class="text-title link-hover-primary">Portakallı Dondurma
                                    Reyon</a></h3>
                            <a href="#" class="btn style-four position-relative z-1 round-10">Ürünü İncele</a>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div
                            ...
                            <div
                                class="product-img d-flex flex-column align-items-center justify-content-center mx-auto">
                                <img src="https://www.karpedo.com/wp-content/uploads/2022/04/22_karamel_reyon_dondurma00-400x336.png"
                                    alt="Ürün görseli" class="d-block mx-auto">
                            </div>
                            <h3 class="fs-24"><a href="#" class="text-title link-hover-primary">Portakallı Dondurma
                                    Reyon</a></h3>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6">
                        <div
                            ...
                            <div
                                class="product-img d-flex flex-column align-items-center justify-content-center mx-auto">
                                <img src="https://www.karpedo.com/wp-content/uploads/2022/04/27_mango_reyon_dondurma00-400x336.png"
                                    alt="Ürün görseli" class="d-block mx-auto">
                            </div>
                            <h3 class="fs-24"><a href="#" class="text-title link-hover-primary">Mangolu Dondurma
                                    Reyon</a></h3>
                            <a href="#" class="btn style-four position-relative z-1 round-10">Ürünü İncele</a>
                        </div>
                    </div>
